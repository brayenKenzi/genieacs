...
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}===========  K   K  EEEEE  N   N  ZZZZZ  IIIII  =============${NC}"   
echo -e "${GREEN}===========  K  K   E      NN  N     Z    I     =============${NC}" 
echo -e "${GREEN}===========  KKK    EEEE   N N N    Z     I     =============${NC}"
echo -e "${GREEN}===========  K  K   E      N  NN   Z      I     =============${NC}"
echo -e "${GREEN}===========  K   K  EEEEE  N   N  ZZZZZ  IIIII  =============${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}================= . Info 085156525848 =======================${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}${NC}"
...
echo -e "${GREEN}=================== Informasi: Whatsapp 085156525848 =======================${NC}"
echo -e "${GREEN}============================================================================${NC}"
